...
def main(argv):
    ...
    with BiaflowsJob.from_cli(argv) as nj:
        ...
        command = "/usr/bin/xvfb-run java -Xmx6000m -cp /fiji/jars/ij.jar ij.ImageJ --headless --console " \
                  "-macro macro.ijm \"input={}, output={}, radiusgray={}, radiuscol={}, threshold={}\"".format(in_path, out_path, nj.parameters.ij_radiusgray, nj.parameters.ij_radiuscol, nj.parameters.ij_threshold)
